...
List<Food> dummy_food = [
  ...
  Food(
    ...
    duration: 15,
    imageUrl:
        "https://cdn0-production-images-kly.akamaized.net/jqey919vhVy-Hd86SHTu8XgI0v0=/1200x675/smart/filters:quality(75):strip_icc():format(webp)/kly-media-production/medias/3129172/original/099632200_1589527804-shutterstock_1455941861.jpg",
  ),
  Food(
    id: DateTime.now().toString(),
    title: "Mie Rebus",
